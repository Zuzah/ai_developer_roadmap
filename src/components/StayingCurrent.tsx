// src/components/StayingCurrent.tsx
// Renders the "Staying Current" tab — cadence blocks, compound rule, ADHD principles.
    ...
    <div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.8, margin: 0 }}>
          ...
          <strong style={{ color: '#FFFFFF' }}>3–6 months</strong>.
