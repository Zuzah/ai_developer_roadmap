    ...
    weeks: [
      ...
      },
      {
        ...
        tasks: [
          ...
          {
            id: 'w2-t7', type: 'watch', required: true,
            title: 'Complete "Building with the Claude API" — Anthropic official course',
            description: 'First-party Anthropic course covering the full API spectrum: models, messages, streaming, tool use, vision, and cost management. Complete every lesson and run every code example. This is the canonical API reference — treat it as required, not optional.',
            estimatedMinutes: 180,
            resource: { label: 'Building with the Claude API', url: 'https://anthropic.skilljar.com/claude-with-the-anthropic-api' },
          },
        ],
      },
      {
    ...
    weeks: [
      {
        ...
        tasks: [
          ...
          {
            id: 'w5-t6', type: 'watch', required: true,
            title: 'Complete "Claude Code in Action" — Anthropic official course',
            description: 'Official Anthropic course on integrating Claude Code into your real development workflow. Watch and replicate every example in one of your existing projects — not a toy repo. Pay attention to the CLAUDE.md and subagent sections; they change how you delegate.',
            estimatedMinutes: 120,
            resource: { label: 'Claude Code in Action', url: 'https://anthropic.skilljar.com/claude-code-in-action' },
          },
        ],
      },
      {
        ...
        tasks: [
          ...
          {
            id: 'w6-t5', type: 'watch', required: true,
            title: 'Complete "Introduction to Agent Skills" — Anthropic official course',
            description: 'Official Anthropic course on building, configuring, and sharing Skills in Claude Code — reusable markdown instructions Claude applies automatically. Complete every lesson, then create one Skill for your own workflow (e.g. a "run tests before committing" skill for your projects).',
            estimatedMinutes: 90,
            resource: { label: 'Introduction to Agent Skills', url: 'https://anthropic.skilljar.com/introduction-to-agent-skills' },
          },
        ],
      },
      {
    ...
    weeks: [
      {
        ...
        tasks: [
          ...
          {
            id: 'w9-t6', type: 'watch', required: true,
            title: 'Complete "Introduction to Model Context Protocol" — Anthropic official course',
            description: 'Official Anthropic course on MCP: tools, resources, and prompts from scratch in Python. Complete every lesson before starting Project 5. The hands-on sections directly map to what you are about to build — treat this as the spec, not supplementary reading.',
            estimatedMinutes: 150,
            resource: { label: 'Introduction to Model Context Protocol', url: 'https://anthropic.skilljar.com/introduction-to-model-context-protocol' },
          },
        ],
      },
      {
      ...
      },
      {
        ...
        tasks: [
          ...
          {
            id: 'w12-t5', type: 'watch', required: true,
            title: 'Complete "MCP: Advanced Topics" — Anthropic official course',
            description: 'Official Anthropic course on production MCP patterns: sampling, notifications, file system access, and transport mechanisms. Complete after your servers are working — these are the techniques that separate a working demo from a production-grade server. Revisit your servers and apply at least 2 patterns from this course.',
            estimatedMinutes: 120,
            resource: { label: 'MCP: Advanced Topics', url: 'https://anthropic.skilljar.com/model-context-protocol-advanced-topics' },
          },
        ],
      },
    ],
